        ...
        <div class="container">
            <div class="card mt-5">
                <div class="card-header text-center">
                    CRUD Data Reward - <strong>TAMBAH DATA</strong>
                </div>
                <div class="card-body">
                    <form method="post" action="/hadiah/store">

                        {{ csrf_field() }}

                        <div class="form-group">
                            <label>Kode Hadiah</label>
                            <input type="text" name="kode_hadiah" class="form-control" placeholder="Masukan Kode Hadiah">
